...
const Events = () => {
    ...
    return (
        <div className="relative py-6 flex flex-col justify-center sm:py-12 z-10">
            <div className="relative py-3 sm:max-w-6xl w-full sm:mx-auto px-8">
                ...
                <div className="space-y-8">
                    {events.length === 0 && !error ? (
                        ...
                        events.map((event, index) => (
                            <div key={event.id}
                                 className="relative bg-zinc-950 text-white border-2 rounded-lg border-sky-200 neon-red p-6 transform hover:-translate-y-2 transition-all duration-300 font-courier-new"
                                 style={{height: '320px', borderRadius: '20px', display: 'flex'}}>
                                            ...
                                            <svg width="24" height="24" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <g clip-path="url(#clip0_81_62)">
                                                    ...
                                                    <path
                                                        ...
                                                        stroke-linejoin="round"/>
                                                    <path
                                                        d="M13.3333 2.60828C14.0503 2.79186 14.6858 3.20886 15.1396 3.79354C15.5935 4.37821 15.8398 5.0973 15.8398 5.83744C15.8398 6.57759 15.5935 7.29668 15.1396 7.88135C14.6858 8.46603 14.0503 8.88303 13.3333 9.06661"
                                                        stroke="#EF4444" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round"/>
                                                    <path
